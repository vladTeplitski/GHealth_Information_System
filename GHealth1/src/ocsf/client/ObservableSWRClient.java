...
private ArrayList<Object> expected = new ArrayList<Object>(3);
   ...
   */
  public synchronized CachedRowSet sendAndWaitForReply(Object message) throws Exception
	{
	return (CachedRowSet) sendAndWaitForReply(message, null);
	}
...
private synchronized Object sendAndWaitForReply(
   ...
   */
  private synchronized Object sendAndWaitForReply(
              Object message, List<Object> expectedListOfObject) throws Exception
  {
	  flag = true;
    ...
    while ( !cancelled && (!expected.isEmpty() || flag))
    {
      wait(waitTime);
      setChanged();
      notifyObservers(WAITING_FOR_REPLY);
